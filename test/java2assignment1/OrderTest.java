...
public class OrderTest {
    ...
    public void testToJson(){
        ...
        assertEquals("{\"orders\":[{\"customerId\":1,\"customerName\":\"a\",\"timeReceived\":\""+order.getTimeReceived()+"\",\"timeProcessed\":\"\",\"timeFulfilled\":\"\",\"purchases\":[{\"quantity\":1,\"productId\":5}],\"notes\":\"\"}]}",order.toJSON());
    }
